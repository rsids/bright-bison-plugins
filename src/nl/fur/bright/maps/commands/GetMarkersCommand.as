package nl.fur.bright.maps.commands
{
	...
	public class GetMarkersCommand extends BaseCommand implements IAsyncCommand, ICommand
	{
		override public function execute(...args):void {
			super.execute(args);
			
			var call:Object = ServiceController.getService("mapsService").getMarkers(args[0][0], false);
