package nl.fur.bright.maps.commands
{
	...
	public class GetPolyLinesCommand extends BaseCommand implements IAsyncCommand, ICommand
	{
		...
		override public function execute(...args):void
		{
			...
			var call:Object = ServiceController.getService("mapsService").getPolys(args[0][0], false);
