package nl.bs10.gmaps.components
{
	...
	public class BrightPoint extends Sprite
	{
		...
		private var _polyLine:BrightPolyLine;
		...
		public function BrightPoint(latLng:LatLng, polyLine:BrightPolyLine, startDragging:Boolean = false)
		{
			super();
			_latLng = latLng;
			_polyLine = polyLine;
		...
		public function redraw(isEnded:Boolean, isClosed:Boolean, thickness:Number, color:Number):void
		{
			...
			var position:Point = _polyLine.pane.map.fromLatLngToViewport(_latLng);
