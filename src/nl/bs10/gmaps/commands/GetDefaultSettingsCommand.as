package nl.bs10.gmaps.commands
{
	...
	public class GetDefaultSettingsCommand extends BaseCommand implements IAsyncCommand, ICommand
	{
		override public function execute(...args):void {
			super.execute(args);
			
			var call:Object = ServiceController.getService("mapsService").getDefaultSettings();
