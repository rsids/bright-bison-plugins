package nl.bs10.gmaps.commands
{
	...
	public class CreateMarkerCommand extends BaseCommand implements IAsyncCommand, ICommand {
		override public function execute(...args):void {
			super.execute(args);
			var lid:int = (args[0][2] && args[0][2].hasOwnProperty('layerId')) ? args[0][2].layerId : -1; 
			var call:Object = ServiceController.getService("mapsService").setMarker(args[0][0], args[0][1], lid);
